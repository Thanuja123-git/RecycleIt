...
public final class ActivityCustomerPageBinding implements ViewBinding {
  ...
  private ActivityCustomerPageBinding(@NonNull LinearLayout rootView, @NonNull Button button2,
      @NonNull Button button3, @NonNull ImageView imageView) {
  ...
  public static ActivityCustomerPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCustomerPageBinding((LinearLayout) rootView, button2, button3, imageView);
    }
